...
import snake.funny.sphere.databinding.ActivityPlayBinding
...
class PlayActivity : AppCompatActivity(), OnTagLongPressedListener, OnTagTapListener {
...
//            .show()
    ...
    private fun showDialogResult(tagItem: TagItem) {
        ...
        resultBinding.btnRemove.clicks().throttleFirst(1, TimeUnit.SECONDS).subscribe() {
            ...
            Toast.makeText(this@PlayActivity, "Deleted Content!", Toast.LENGTH_SHORT).show()
            dialog.dismiss()
        }
